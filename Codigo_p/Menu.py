...
def menu_api():
    ...
    #Menu principal, para ingresar al menu de crud se debe ingresar con exito
    while True:
        print("\n========================")
...
#Menu del crud, aqui se acceden a todas las opciones
def menu_crud(api):
    while True:
        print("MENU CRUD")
        print("========================")
...
#Aqui se llama a la funcion del menu principal
